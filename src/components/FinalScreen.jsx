...
export default function FinalMessageScreen() {
  ...
  const messages = [
    "Hey bestie! 💕",
    "pehli thing mein zyada sundar hoon.",
    "Darr ke raha kar mujhse mein boss",
    "Moti hoti jaa rahi hain tu",
    "Bhuat nakchadi han tu",
    "khud se yaad bhi kiya kar mein hi karta rehta",
    "Happy Friendship Day, my bestest bestest friend! 💖",
  ]

  const titleWords = ["HAPPY", "FRIENDSHIP", "DAY!","Panda"]
